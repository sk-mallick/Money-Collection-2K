 ...
 * Visit this script in your browser to seed/update the remote hosted database.
 * 
 * SECURITY: Requires a secret query parameter: ?secret=import2026
 * DELETE this file from your server after successful execution!
 */

header('Content-Type: text/plain; charset=utf-8');

// Simple secret token check
if (!isset($_GET['secret']) || $_GET['secret'] !== 'import2026') {
    http_response_code(403);
    echo "Access Denied: Invalid or missing secret token.";
    exit;
}
...
try {
    ...
    // 2. Load groups.json
    $groupsPath = __DIR__ . '/backend/data/groups.json';
    ...
    $studentsPath = __DIR__ . '/backend/data/students.json';
