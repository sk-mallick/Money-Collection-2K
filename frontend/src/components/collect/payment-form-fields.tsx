    ...
    <>
      ...
      {showAdmissionFeeToggle && (
        <button
          ...
          className={`
            w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl border-2 transition-all duration-200 cursor-pointer text-left
            ${includeAdmissionFee
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span className="text-[11px] text-muted-foreground block mt-0.5 truncate">
                {includeAdmissionFee
                  ? `₹${admissionFeeAmount.toLocaleString('en-IN')} will be included in the generated receipt & PDF`
                  : `Enable to add ₹${admissionFeeAmount.toLocaleString('en-IN')} admission fee to this receipt & PDF`}
              </span>
            </div>
          </div>
